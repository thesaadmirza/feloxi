<p align="center">
  <img src="https://raw.githubusercontent.com/thesaadmirza/feloxi/main/.github/logo.svg" alt="Feloxi — Open-source Celery monitoring dashboard" width="120" />
</p>
...
| Variable  | Default                 | Description                                                      |
| --------- | ----------------------- | ---------------------------------------------------------------- |
| `API_URL` | `http://localhost:8080` | Backend API URL (server-side, proxied via Next.js rewrites)      |
