...
#[openapi(
    ...
    tags(
        ...
        (name = "integrations", description = "Connected notification integrations"),
    ...
    paths(
        ...
        crate::routes::alerts::expire_silence,
        // Integrations
        crate::routes::integrations::list_integrations,
        crate::routes::integrations::oauth_providers,
        crate::routes::integrations::delete_integration,
        crate::routes::integrations::test_integration,
        crate::routes::oauth_slack::slack_channels,
        // Metrics
    ...
    components(schemas(
        ...
        crate::routes::alerts::CreateSilenceRequest,
        ...
        db::postgres::models::AlertSilence,
        db::postgres::models::ChannelDeliveryStatus,
        db::postgres::models::IntegrationView,
        crate::routes::integrations::IntegrationsResponse,
        crate::routes::integrations::OAuthProvidersResponse,
        crate::routes::integrations::TestIntegrationRequest,
        crate::routes::integrations::TestIntegrationResponse,
        crate::routes::oauth_slack::SlackChannel,
        crate::routes::oauth_slack::SlackChannelsResponse,
        ...
        crate::routes::responses::SilencesResponse,
